...
function WhatsAppCall() {
  ...
  return (
    <motion.a
      ...
      className="group flex items-center gap-4 rounded-2xl bg-[#25d366] p-4 text-white sm:p-5"
    >
      <span className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-white text-[#25d366]">
      ...
      <span className="hidden shrink-0 items-center gap-2 rounded-full bg-white px-5 py-3 text-[0.75rem] font-bold tracking-[0.12em] text-[#25d366] uppercase sm:inline-flex">
        Abrir WhatsApp
        <ArrowUpRight
          size={16}
          strokeWidth={2.6}
